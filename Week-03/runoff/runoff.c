...
bool vote(int voter, int rank, string name)
{
    // Loop through total number of candidates
    for (int i = 0; i < candidate_count; i++)
    {
        // Compare entered name with candidates names
...
void tabulate(void)
{
    // Loop through total number of voters
    for (int i = 0; i < voter_count; i++)
    {
        // Loop through total number of candidates
        for (int j = 0; j < candidate_count; j++)
...
bool print_winner(void)
{
    ...
    for (int i = 0; i < voter_count; i++)
    {
        ...
        // If candidate votes are more than half of the voters total
...
void eliminate(int min)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        // If candidate vote is equalt to min, flag candidate as eliminated
